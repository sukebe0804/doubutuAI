...
public class MainSimu {
    public static void main(String[] args) {
        ...
        // PlayerA.trial(1000);
        // AlphaBeta PlayerB= new AlphaBeta("ABPlayer");
        // MinMax PlayerA = new MinMax("MinMax");
        // AlphaBeta PlayerA = new AlphaBeta("AlphaBeta");
        // ABPlayer PlayerB = new ABPlayer("ABPlayer");
        AI_gj PlayerB = new AI_gj("AI_gj");
        QLearn PlayerA = new QLearn("QLearn");
        PlayerA.loadQTable("qtable.dat");
